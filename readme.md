...
[login.py](/login.py) -> [Output](/images/Login.png) | [inheritance.py](/inheritance.py) -> [Output](/images/Inheritance.png) | [polymorphism.py](/polymorphism.py) -> [Output](/images/Polymorphism.png) | [abstraction.py](/abstraction.py) -> [Output](/images/Abstraction.png)
...
- Decorator -> [Video 1](https://www.youtube.com/watch?v=FsAPt_9Bf3U) | [Video 2](https://www.youtube.com/watch?v=KlBPCzcQNU8) | [decorator.py](/decorator.py) | [Output](/images/Decorator.png)
- Map Filter Reduce Lambda -> [Video 1](https://www.youtube.com/watch?v=kYIrDMbqunw) | [Video 2](https://www.youtube.com/watch?v=cKlnR-CB3tk) | [advance.py](/advance.py) | [Output](/images/Lambda.png)
- File Objects -> [Video](https://www.youtube.com/watch?v=Uh2ebFW8OYM) | [file.py](/file.py) | [Output](/images/File.png)
- Singletons -> [Video 1](https://www.youtube.com/watch?v=6IV_FYx6MQA) | [Video 2](https://www.youtube.com/watch?v=sppHANksoG4) | [singleton.py](/singleton.py) | [Output](/images/Singleton.png)
- Python Debugger -> [Video](https://www.youtube.com/watch?v=ChuU3NlYRLQ) | [advance.py](/advance.py) | [Output](/images/PDB.png)
- AsyncIO -> [Video 1](https://www.youtube.com/watch?v=6RbJYN7SoRs) | [Video 2](https://www.youtube.com/watch?v=RIVcqT2OGPA) | [advance.py](/advance.py) | [Output](/images/AsyncIO.png)
...
- Iterators and Generators -
  ...
  - Code - [iterator&generator.py](/iterator&generator.py)
...
- Collections -
  ...
  - Code - [collection.py](/collection.py)
...
- Serialization/Pickling -
  ...
  - Code - [serialization.py](/serialization.py)
